 ...
 * @see AlgoPHM
 */
public class DescriptionAlgoPHMN extends DescriptionOfAlgorithm {

    /**
     * Default constructor
     */
    public DescriptionAlgoPHMN() {
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/PHMN-periodic-PHMN.php";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ...
        algo.runAlgorithm(false, inputFile, outputFile, minutil, minPeriodicity, maxPeriodicity, minAveragePeriodicity, maxAveragePeriodicity);
        algo.printStats();
    }

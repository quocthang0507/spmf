...
/**
 * This class describes the FastTIRP algorithm parameters. It is designed to be used by the graphical and command line interface.
 *
 * @author Philippe Fournier-Viger and Yuechun Li
 * @see AlgoFastTIRP
 */
public class DescriptionAlgoFastTIRP extends DescriptionOfAlgorithm {

    /**
     * Default constructor
     */
    public DescriptionAlgoFastTIRP() {
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/fasttirp_intervals.php";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ...
        algo.runAlgorithm(inputFile, outputFile, minHorSup, minVertSup, epsilon, mingap, maxgap, minDuration, maxDuration,
                maxPatternLength, detailedOutput, true);

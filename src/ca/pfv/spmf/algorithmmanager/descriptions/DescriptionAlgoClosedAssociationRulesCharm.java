...
/**
 * This class describes parameters of the algorithm for generating closed
 * association rules with the CHARM algorithm. It is designed to be used by the
...
public class DescriptionAlgoClosedAssociationRulesCharm extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ...
        ca.pfv.spmf.patterns.itemset_array_integers_with_tids_bitset.Itemsets patterns = algo.runAlgorithm(null,
                database, minsup, true, 10000);
        algo.printStats();

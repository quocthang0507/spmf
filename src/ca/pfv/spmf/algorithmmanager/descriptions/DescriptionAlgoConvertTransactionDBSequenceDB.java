...
/**
 * This class describes the algorithm to convert a transaction database to a
 * sequence database. It is designed to be used by the graphical and command
 * line interface.
 *
...
public class DescriptionAlgoConvertTransactionDBSequenceDB extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ...
        System.out.println(
                "Transaction database converted.  Time spent for conversion = " + (endTIme - startTime) + " ms.");
    }

 ...
 * open a sequence database file with cost and numeric utility values
 *
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoSequenceCostNumericUtilityDBViewerOpenFile extends DescriptionOfAlgorithm {

    /**
     * Default constructor
     */
    public DescriptionAlgoSequenceCostNumericUtilityDBViewerOpenFile() {
    }

    @Override
    public String getName() {
        return "Open_sequence_database_cost_numeric_utility_file_with_viewer";
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/Seq_with_cost_numeric_utility_db_viewer.php";
    }

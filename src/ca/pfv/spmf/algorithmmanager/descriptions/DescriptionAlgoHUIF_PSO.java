...
/**
 * This class describes the HUIF-PSO algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 *
 * @author Philippe Fournier-Viger
 * @see AlgoBio_HUIF_PSO
 */

public class DescriptionAlgoHUIF_PSO extends DescriptionOfAlgorithm {

    /**
     * Default constructor
     */
    public DescriptionAlgoHUIF_PSO() {
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/HUIF-PSO.php";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ...
        AlgoBio_HUIF_PSO algo = new AlgoBio_HUIF_PSO();

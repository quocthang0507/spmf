...
/**
 * This class describes parameters of the algorithm for generating association
 * rules with the RPGrowth algorithm. It is designed to be used bt the graphical
 * and command line interface. It is a modification of Philippe Fournier-Viger's
...
public class DescriptionAlgoRPGrowthAssociationRules extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ...
        ca.pfv.spmf.patterns.itemset_array_integers_with_count.Itemsets patterns = rpgrowth.runAlgorithm(inputFile,
                null, minsup, minraresup);
        rpgrowth.printStats();

...
/**
 * This class describes the algorithm to convert a sequence database with cost
 * values to a transaction database. It is designed to be used by the graphical
...
public class DescriptionAlgoConvertCostSequenceDBTransactionDB extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ...
        converter.convert(inputFile, outputFile, Formats.SPMF.SPMF_COST_SEQUENCE_DB, transactionCount);
        long endTIme = System.currentTimeMillis();
        System.out
                .println("Sequence database converted.  Time spent for conversion = " + (endTIme - startTime) + " ms.");
    }

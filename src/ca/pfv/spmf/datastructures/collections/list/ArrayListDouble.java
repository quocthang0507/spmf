...
/**
 * This class implements a simple array of doubles (primitive type) that is
...
public class ArrayListDouble extends ListDouble {
     ...
     */
    public void sort(ComparatorDouble comparator) {
        double temp;
     ...
     * @return the sublist
     */
    public ListDouble immutableSubList(int fromPosition, int toPosition) {
        if (fromPosition < 0) {
    ...
    public class ImmutableSublistObject extends ListDouble {
         ...
         * @param toPosition      the position where the sublist ends (exclusive)
         */
        public ImmutableSublistObject(ListDouble arrayListObject, int fromPosition, int toPosition) {

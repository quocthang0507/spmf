...
/**
 * A Hashset, optimized to store objects. The hash function is the hashcode
 * function of the Object class. The internal structure is an array, and
 * collisions are managed using a custom linked-list. This implementation is not
 * synchronized.
 * <p>
 * The set implements a rehashing strategy where the number of buckets in the internal hash

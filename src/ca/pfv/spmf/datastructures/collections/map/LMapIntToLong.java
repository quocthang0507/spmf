 ...
 * @see MapIntToLong
 */
public class LMapIntToLong extends MapIntToLong {
     ...
     */
    public LMapIntToLong(int initialCapacity) {
        elementCount = 0;
     ...
     *                        default is 0.8)
     */
    public LMapIntToLong(int initialCapacity, double maximum_load) {
        elementCount = 0;
        buckets = new Entry[initialCapacity];

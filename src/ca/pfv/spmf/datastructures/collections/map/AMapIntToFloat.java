...
import ca.pfv.spmf.datastructures.collections.map.AMapIntToInt.Entry;
...
/**
 * A Hashmap, optimized to map integers to float (primitive types). The hash
 ...
 * @see MapIntToFloat
 */
public class AMapIntToFloat extends MapIntToFloat {
     ...
     */
    public AMapIntToFloat(int initialCapacity) {
        elementCount = 0;
     ...
     *                                 collision list
     */
    public AMapIntToFloat(int initialCapacity, int initialCollisionListSize) {
        elementCount = 0;
        buckets = new ArrayListObject[initialCapacity];
    ...
    @Override
    public void getAndIncreaseValueBy(int key, float valueToAdd) {
        int initialIndex = hash(key);
     ...
     */
    public class Entry extends MapEntryIntToFloat {
        /**
         * a key
         */
        public int key;

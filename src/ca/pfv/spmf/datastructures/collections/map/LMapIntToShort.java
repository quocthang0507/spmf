...
/**
 * A Hashmap, optimized to map integers to short (primitive types). The hash
 ...
 * @see MapIntToShort
 */
public class LMapIntToShort extends MapIntToShort {
     ...
     */
    public LMapIntToShort(int initialCapacity) {
        elementCount = 0;
     ...
     *                        default is 0.8)
     */
    public LMapIntToShort(int initialCapacity, double maximum_load) {
        elementCount = 0;
        buckets = new Entry[initialCapacity];

...
import ca.pfv.spmf.datastructures.collections.map.LMapIntToLong.Entry;
...
/**
 * A Hashmap, optimized to map integers to double (primitive types). The hash
 ...
 * @see MapIntToDouble
 */
public class LMapIntToDouble extends MapIntToDouble {
     ...
     */
    public LMapIntToDouble(int initialCapacity) {
        elementCount = 0;
     ...
     *                        default is 0.8)
     */
    public LMapIntToDouble(int initialCapacity, double maximum_load) {
        elementCount = 0;
        buckets = new Entry[initialCapacity];
    ...
    @Override
    public void getAndIncreaseValueBy(int key, double valueToAdd) {
        // ================ FOR REHASHING =================
     ...
     */
    public class Entry extends MapEntryIntToDouble {
        /**
         * a key
         */
        int key;
    ...
    public class LEntryIterator extends EntryIterator {
         ...
         * entry
         */
        public MapEntryIntToDouble next() {
            if (nextEntry == null) {

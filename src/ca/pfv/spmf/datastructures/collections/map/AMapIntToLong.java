 ...
 * @see MapIntToLong
 */
public class AMapIntToLong extends MapIntToLong {
     ...
     */
    public AMapIntToLong(int initialCapacity) {
        elementCount = 0;
     ...
     *                                 collision list
     */
    public AMapIntToLong(int initialCapacity, int initialCollisionListSize) {
        elementCount = 0;
        buckets = new ArrayListObject[initialCapacity];
    ...
    @Override
    public void getAndIncreaseValueBy(int key, long valueToAdd) {
        int initialIndex = hash(key);
     ...
     */
    public class Entry extends MapEntryIntToLong {
        /**
         * a key
         */
        public int key;

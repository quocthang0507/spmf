 ...
 * @see MapIntToFloat
 */
public class LMapIntToFloat extends MapIntToFloat {
     ...
     */
    public LMapIntToFloat(int initialCapacity) {
        elementCount = 0;
     ...
     *                        default is 0.8)
     */
    public LMapIntToFloat(int initialCapacity, double maximum_load) {
        elementCount = 0;
        buckets = new Entry[initialCapacity];

...
/**
 * A class for testing the ArrayListDouble class
 *
...
public class MainTestArrayListDouble {
    ...
    private static void runExperiment(int initialSize) {
        ListDouble list = new ArrayListDouble(initialSize);
        printContent(list);
        ...
        //-------------------------- Iterator
        ca.pfv.spmf.datastructures.collections.list.ListDouble.IteratorList iterator = list.iterator();
        ...
        list.sort(new ComparatorDouble() {
        ...
        ListDouble sublist = list.immutableSubList(1, 3);
        ...
        ListDouble sublist2 = list.immutableSubList(3, 4);
    ...
    private static void indexOfVal(ListDouble list, double val) {
        System.out.println("index of value " + val + "  is: " + list.indexOf(val));
    }

    private static void printContent(ListDouble list) {
    ...
    private static void addToList(ListDouble list, double value) {
        System.out.println("ADD " + value);
        list.add(value);
    }

    private static void removeAtFromList(ListDouble list, int index) {

...
/**
 * A class for testing the ArrayListFloat class
 *
...
public class MainTestArrayListFloat {
    ...
    public static void main(String[] args) {
        ...
        // We test this because this should not change the behavior of the structure from the outside.
    ...
    private static void runExperiment(int initialSize) {
        ListFloat list = new ArrayListFloat(initialSize);
        printContent(list);
        ...
        //-------------------------- Iterator
        ca.pfv.spmf.datastructures.collections.list.ListFloat.IteratorList iterator = list.iterator();
        ...
        CheckResults.checkResult(list.size() == 7);
        CheckResults.checkResult(list.get(0) == 8f);
        CheckResults.checkResult(list.get(1) == 8f);
        CheckResults.checkResult(list.get(2) == 6f);
        CheckResults.checkResult(list.get(3) == 5f);
        CheckResults.checkResult(list.get(4) == 4f);
        CheckResults.checkResult(list.get(5) == 3f);
        CheckResults.checkResult(list.get(6) == 1f);

        ///  IMMUTABLE SUBLIST TEST
        ListFloat sublist = list.immutableSubList(1, 3);
        ...
        ListFloat sublist2 = list.immutableSubList(3, 4);
    ...
    private static void indexOfVal(ListFloat list, float val) {
        System.out.println("index of value " + val + "  is: " + list.indexOf(val));
    }

    private static void printContent(ListFloat list) {
    ...
    private static void addToList(ListFloat list, float value) {
        System.out.println("ADD " + value);
        list.add(value);
    }

    private static void removeAtFromList(ListFloat list, int index) {

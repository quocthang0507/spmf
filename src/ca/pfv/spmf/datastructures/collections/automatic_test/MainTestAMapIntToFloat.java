...
import ca.pfv.spmf.datastructures.collections.map.MapIntToFloat.ValueIterator;
...
/**
 * A class for testing the AMapIntToFloat class.
 *
 * @author Philippe Fournier-Viger, 2023
 */
public class MainTestAMapIntToFloat {
    ...
    private static void runExperiment(int bucketCount, int collisionArraySize) {
        MapIntToFloat hashMap = new AMapIntToFloat(bucketCount, collisionArraySize);
        ...
        AMapIntToFloat hashMap2 = new AMapIntToFloat(bucketCount);

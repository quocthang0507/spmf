...
/**
 * A class for testing the AMapIntToShort class.
 *
 * @author Philippe Fournier-Viger, 2023
 */
public class MainTestAMapIntToShort {
    ...
    private static void runExperiment(int bucketCount, int collisionArraySize) {
        ...
        hashMap.put(1, (short) 1000);
        System.out.println("ADD 2, 2000");
        hashMap.put(2, (short) 2000);
        System.out.println("ADD 6, 6000");
        hashMap.put(6, (short) 6000);
        ...
        Set<MapEntryIntToShort> hashSetResults = new HashSet<>();
        int count = 0;
        while (iter.hasNext()) {
            MapEntryIntToShort node = iter.next();
        ...
        Set<MapEntryIntToShort> hashSetResults2 = new HashSet<>();
        int count2 = 0;
        while (iter2.hasNext()) {
            MapEntryIntToShort node = iter2.next();
            count2++;
        ...
        Set<MapEntryIntToShort> hashSetResults3 = new HashSet<>();
        int count3 = 0;
        while (iter3.hasNext()) {
            MapEntryIntToShort node3 = iter3.next();
        ...
        MapEntryIntToShort x = iter5.next();
        ...
        MapEntryIntToShort x6 = iter6.next();
        ...
        HashMap<Integer, Short> mirror = new HashMap<Integer, Short>();

        Random rand = new Random(System.currentTimeMillis());
        int i = 0;
        while (i < 50) {
            int randomNumber = rand.nextInt(100) + 1;
            hashMap.put(randomNumber, (short) (randomNumber + 1));
            mirror.put(randomNumber, (short) (randomNumber + 1));
            i++;
        ...
        MapIntToShort hashMap2 = new LMapIntToShort(bucketCount);
        ...
        hashMap2.getAndIncreaseValueBy(2, (short) 5);
        CheckResults.checkResult(hashMap2.containsKey(2));
        CheckResults.checkResult(hashMap2.get(1) == 10);
        ...
        hashMap2.getAndIncreaseValueBy(1, (short) 2);
        hashMap2.getAndIncreaseValueBy(2, (short) 5);
        CheckResults.checkResult(hashMap2.size() == 2);
        CheckResults.checkResult(hashMap2.containsKey(1));
        CheckResults.checkResult(hashMap2.containsKey(2));
        ...
        hashMap2.getAndIncreaseValueBy(3, (short) 33);
        hashMap2.getAndIncreaseValueBy(4, (short) 44);

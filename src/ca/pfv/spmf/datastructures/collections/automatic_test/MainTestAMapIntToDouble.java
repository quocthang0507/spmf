...
/**
 * A class for testing the AMapIntToDouble class.
 *
 * @author Philippe Fournier-Viger, 2023
 */
public class MainTestAMapIntToDouble {
    ...
    private static void runExperiment(int bucketCount, int collisionArraySize) {
        MapIntToDouble hashMap = new AMapIntToDouble(bucketCount, collisionArraySize);
        ...
        Set<MapEntryIntToDouble> hashSetResults = new HashSet<>();
        int count = 0;
        while (iter.hasNext()) {
            MapEntryIntToDouble node = iter.next();
        ...
        Set<MapEntryIntToDouble> hashSetResults2 = new HashSet<>();
        int count2 = 0;
        while (iter2.hasNext()) {
            MapEntryIntToDouble node = iter2.next();
            count2++;
        ...
        Set<MapEntryIntToDouble> hashSetResults3 = new HashSet<>();
        int count3 = 0;
        while (iter3.hasNext()) {
            MapEntryIntToDouble node3 = iter3.next();
        ...
        MapEntryIntToDouble x = iter5.next();
        ...
        MapEntryIntToDouble x6 = iter6.next();
        ...
        MapIntToDouble hashMap2 = new AMapIntToDouble(bucketCount);
        ...
        ca.pfv.spmf.datastructures.collections.map.MapIntToDouble.ValueIterator iterVal = hashMap2.iteratorForValues();
        ...
        CheckResults.checkResult(setValues.contains(12d));
        CheckResults.checkResult(setValues.contains(30d));
        CheckResults.checkResult(setValues.contains(33d));
        CheckResults.checkResult(setValues.contains(44d));
        CheckResults.checkResult(setValues.size() == 4);

        //===== KEY ITERATOR
        ca.pfv.spmf.datastructures.collections.map.MapIntToDouble.KeyIterator iterKey = hashMap2.iteratorForKeys();

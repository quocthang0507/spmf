...
/**
 * A class for testing the LMapIntToDouble class.
 *
 * @author Philippe Fournier-Viger, 2023
 */
public class MainTestLMapIntToDouble {
    ...
    private static void runExperiment(int bucketCount) {
        MapIntToDouble hashMap = new LMapIntToDouble(bucketCount);
...
//				System.out.println(bucketCount);
        ...
        MapIntToDouble hashMap2 = new LMapIntToDouble(bucketCount);

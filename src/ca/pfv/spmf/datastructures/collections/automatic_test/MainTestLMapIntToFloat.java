...
import ca.pfv.spmf.datastructures.collections.map.LMapIntToFloat;
import ca.pfv.spmf.datastructures.collections.map.LMapIntToFloat.LValueIterator;
import ca.pfv.spmf.datastructures.collections.map.LMapIntToInt;
import ca.pfv.spmf.datastructures.collections.map.MapIntToFloat;
import ca.pfv.spmf.datastructures.collections.map.MapIntToFloat.MapEntryIntToFloat;
...
import ca.pfv.spmf.datastructures.collections.map.MapIntToFloat.EntryIterator;
...
/**
 * A class for testing the LMapIntToFloat class.
 *
 * @author Philippe Fournier-Viger, 2023
 */
public class MainTestLMapIntToFloat {
    ...
    private static void runExperiment(int bucketCount) {
        MapIntToFloat hashMap = new LMapIntToFloat(bucketCount);
        ...
        Set<MapEntryIntToFloat> hashSetResults = new HashSet<>();
        int count = 0;
        while (iter.hasNext()) {
            MapEntryIntToFloat node = iter.next();
        ...
        Set<MapEntryIntToFloat> hashSetResults2 = new HashSet<>();
        int count2 = 0;
        while (iter2.hasNext()) {
            MapEntryIntToFloat node = iter2.next();
            count2++;
        ...
        Set<MapEntryIntToFloat> hashSetResults3 = new HashSet<>();
        int count3 = 0;
        while (iter3.hasNext()) {
            MapEntryIntToFloat node3 = iter3.next();
...
//				System.out.println(bucketCount);
        ...
        MapEntryIntToFloat x = iter5.next();
        ...
        MapEntryIntToFloat x6 = iter6.next();
        ...
        LMapIntToFloat hashMap2 = new LMapIntToFloat(bucketCount);
        ...
        LValueIterator iterVal = hashMap2.iteratorForValues();
        Set setValues = new HashSet<Integer>();
        while (iterVal.hasNext()) {
            float value = iterVal.next();
            System.out.println("Value : " + value);
            setValues.add(value);
        }

        CheckResults.checkResult(setValues.contains(12f));
        CheckResults.checkResult(setValues.contains(30f));
        CheckResults.checkResult(setValues.contains(33f));
        CheckResults.checkResult(setValues.contains(44f));
        CheckResults.checkResult(setValues.size() == 4);

        //===== KEY ITERATOR
        ca.pfv.spmf.datastructures.collections.map.MapIntToFloat.KeyIterator iterKey = hashMap2.iteratorForKeys();

...
public class SequenceDatabase {
        ...
        for (String integer : tokens) {
            ...
            if (integer.codePointAt(0) == '<') {
                ...
                if (indexLeftParenthesis != -1) {
                    ...
                    int itemAsInteger = Integer.parseInt(integer);
                    ItemValued item = new ItemValued(itemAsInteger, value);
                    // The item is then added to the current itemset
                    itemset.addItem(item);

                    if (itemAsInteger > maxItemID) {
                        maxItemID = itemAsInteger;
                    }
                } else {
                    ...
                    int itemAsInteger = Integer.parseInt(integer);
                    ItemSimple item = new ItemSimple(itemAsInteger);
    ...
    /**
     * Get the largest item ID in this database
     *

...
public class PseudoSequence {
    ...
    /**
     * //// 鎴戜滑浠庡厛鍓嶇殑鎶曞奖搴忓垪涓緱鍒颁竴涓姇褰卞簭鍒椼�傚洜姝や粠浠庡厛鍓嶆姇褰变腑鍒堕�犳姇褰憋紝鎴戜滑瑕佽�冭檻鍒版姇褰辩殑鍏堝墠鎸囨爣锛燂紵
    ...
    public int size(int i) {
        ...
        //System.out.println(firstItemset);
    ...
    public int numberOfProjectionsIncluded() {
        ...
        //System.out.println("@@@@@@firstItemset: "+ firstItemset);
    ...
    public long getAbsoluteTimeStamp(int itemsetIndex, int firstItemset) {
        //System.out.println("=======================================================test23 pseudosequence.java");
        //System.out.println("getAbsoluteTimeStamp: "+getItemset(itemsetIndex, firstItemset).getTimestamp());

...
/**
 * * This is an implementation of the VGEN algorithm. <br/>
 * <br/>
 * <p>
 * Copyright (c) 2014 Philippe Fournier-Viger, Antonio Gomariz <br/>
 * <br/>
 * <p>
...
public class AlgoVGEN {
    ...
    /**
     * GENERATOR PATTERNS - The list contains patterns of size k at position k in
     * the list. A map has the sum of sids as key and lists of patterns as value.
     */
    ...
    /**
     * the number of transaction in the database (to calculate the support of the
     * empty set)
     */
     ...
     */
    public List<Map<Integer, List<PatternVGEN>>> runAlgorithm(String input, String outputFilePath, double minsupRel)
            throws IOException {
        if (DEBUG_MODE) {
...
//	        		System.out.println(" " + pat.prefix  + "    sup: " + pat.getSupport());
            ...
            // CHECK IF SOME PATTERNS ARE NOT GENERATORS
            for (PatternVGEN pat1 : listPatterns) {
                ...
                if (pat1.prefix.size() > 0 && pat1.getAbsoluteSupport() == transactionCount) {
                    System.out.println("NOT A GENERATOR !!!!!!!!!  " + pat1.prefix + "    sup: "
                            + pat1.bitmap.getSupport() + " because of empty set");
                }
...
//									if (itemI != itemJ){
        ...
        // NEW2014: SAVE ALL SINGLE FREQUENT ITEMS FIRST BEFORE PERFORMING DEPTH FIRST
        // SEARCH =========
        ...
        for (Entry<Integer, Bitmap> entry : verticalDB.entrySet()) {
            ...
            // NEW 2014 : IMPORTANT!!!! -- > DON'T OUTPUT PATTERN IF SUPPORT IS EQUAL TO SDB
            // SIZE
            // BUT NOTE THAT WE WILL STILL NEED TO DO THE DEPTH FIRST SEARCH FOR THIS
            // PATTERN IN THE NEXT FOR LOOP...
     ...
     */
    void dfsPruning(PrefixVGEN prefix, Bitmap prefixBitmap, List<Integer> sn, List<Integer> in,
...
//            prefixSStep.sumOfItems = item + prefix.sumOfItems;
     ...
     * @return true IF THE PATTERN HAS A BACKWARD EXTENSION WITH THE SAME PROJECTED
     * DATABASE
...
//    	System.out.println("prefix :" + prefix);
            ...
            for (PatternVGEN pPrime : level) {
                ...
                if (prefix.sumOfEvenItems >= pPrime.prefix.sumOfEvenItems
                    ...
                    if (useBackwardPruning) {
                        ...
                        // WE JUST RETURN FALSE IF WE DON'T USE THE BACKWARD PRUNING. THIS IS A
                        // TRADE-OFF
                        return false;
                    }
                    // END IMPORTANT
    ...
    /**
     * Check if there is a backward extension by comparing the bitmap of two
     * patterns P1 and P2, such that P1 is a superset of P2
     *
...
//		return bitmap.equals(bitmap2);
     ...
     * @return true if the pattern1 contains pattern2.
     */
    boolean strictlyContainsWithoutMaxgap(PrefixVGEN pattern1, PrefixVGEN pattern2) {
...
//			// be impossible to get a total match, and so we return false.
     ...
     * @return true if the pattern1 contains pattern2.
     */
    boolean strictlyContainsWithMaxgap(PrefixVGEN pattern1, PrefixVGEN pattern2) {
        // To see if pattern2 is strictly contained in pattern1,
        // we will search for each itemset i of pattern2 in pattern1 by advancing
        // in pattern 1 one itemset at a time.
...
//		System.out.println();
     ...
     */
    private boolean strictlyContainsWithMaxGapHelper(PrefixVGEN pattern1, PrefixVGEN pattern2, int pos1, int pos2, int lastMatchingPositionOfPattern1) {

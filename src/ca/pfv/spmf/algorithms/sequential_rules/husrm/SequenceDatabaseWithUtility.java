...
public class SequenceDatabaseWithUtility {
     ...
     * @param doNotRemoveItems         If true, items will not be removed as part of optimization
     * @throws IOException exception if error while reading the file.
     */
    public void loadFile(String path, int maximumNumberOfSequences, boolean doNotRemoveItems) throws IOException {
        ...
        try {
            ...
            while ((thisLine = myInput.readLine()) != null) {
                ...
                if (thisLine.isEmpty() == false && thisLine.charAt(0) != '#' && thisLine.charAt(0) != '%'
                    ...
                    addSequence(split, doNotRemoveItems);
                    i++;
     ...
     * @param doNotRemoveItems If true, items will not be removed as part of optimization
     */
    void addSequence(String[] tokens, boolean doNotRemoveItems) {
        ...
        for (String token : tokens) {
            ...
            // the sequence.
                ...
                // ***************************************************************
                // ***************************************************************
                if (alreadySeenItems.contains(itemInt) == false || doNotRemoveItems == true) {

...
public class ProjectedIteratorProducer implements Runnable {
    ...
    // projections queue into which producers insert created projections
    private BlockingQueue<PDFSCompact> pdfsQueue;
    // flag to signal producer to stop running
    private ProjectedIteratorConsumer.Control control;
    ...
    public ProjectedIteratorProducer(ProjectedCompact projected, BlockingQueue<PDFSCompact> pdfsQueue, ProjectedIteratorConsumer.Control control, List<ProjectedEdge> firstEdges) {
        this.projected = projected;
        this.pdfsQueue = pdfsQueue;
        this.control = control;
        this.firstEdges = firstEdges;
        firstEdgeIndex = 0;
    }

    public ProjectedIteratorProducer(ProjectedCompact projected, BlockingQueue<PDFSCompact> pdfsQueue, ProjectedIteratorConsumer.Control control, List<ProjectedEdge> firstEdges, List<IProjectedIteratorCallback> callbacks) {
        this.projected = projected;
        this.pdfsQueue = pdfsQueue;
        this.control = control;
    ...
    public ProjectedIteratorProducer(ProjectedCompact projected, BlockingQueue<PDFSCompact> pdfsQueue, ProjectedIteratorConsumer.Control control, List<ProjectedEdge> firstEdges, int gid) {
        this.projected = projected;
        this.pdfsQueue = pdfsQueue;
        this.control = control;
        this.firstEdges = firstEdges.stream().filter(e -> e.getEdgeEnumeration().getGid() == gid).collect(Collectors.toList());
        firstEdgeIndex = 0;
    }

    public ProjectedIteratorProducer(ProjectedCompact projected, BlockingQueue<PDFSCompact> pdfsQueue, ProjectedIteratorConsumer.Control control, List<ProjectedEdge> firstEdges, int gid, List<IProjectedIteratorCallback> callbacks) {
        this.projected = projected;
        this.pdfsQueue = pdfsQueue;
        this.control = control;
        this.callbacks = callbacks;
    ...
    public void setProjected(ProjectedCompact projected) {
        this.projected = projected;
    }
}

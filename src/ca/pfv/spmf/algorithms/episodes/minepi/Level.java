...
public class Level {
     ...
     */
    List<SerialEpisode> k_frequentEpisodes;
     ...
     */
    public void addFreEpisode(SerialEpisode episode) {
     ...
     */
    public void addFreEpisodeAndBlockStart(SerialEpisode episode, int index) {
        this.k_frequentEpisodes.add(episode);

...
public class EncodingTable {
     ...
     */
    public void addEpisodeAndBoundlist(EpisodeMaxEPM episode, List<int[]> boundlist) {
        f1.add(episode);
     ...
     * @return the episode
     */
    public EpisodeMaxEPM getEpisodebyID(int id) {
     ...
     */
    public List<EpisodeMaxEPM> getF1() {
        return f1;
    }

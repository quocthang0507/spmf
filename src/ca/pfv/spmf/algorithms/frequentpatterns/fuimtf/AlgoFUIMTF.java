...
/**
 * This is an implementation of the FUIMTF-Tree algorithm, which is inspired by
 * mHUIMiner. Thanks for SPMF library for providing the source code of mHUIMiner.
 * The code is under the GPLv3 license as it contains GPL code.
 */
...
public class AlgoFUIMTF {
    ...
    public void runAlgorithm(String input, String output, int minimumUtility, Double minsupDouble) throws IOException {
        ...
        System.out.println("****************");
        System.out.println("minsup = " + minsupDouble);
        // ******************************************
    ...
    private int compareItemsAsc(int item1, int item2, Map<Integer, Integer> mapItemSupport) {
        int compare = mapItemSupport.get(item1) - mapItemSupport.get(item2);
    ...
    private IHUPTreeMod createLocalTree(IHUPTreeMod tree, Integer itemID) {
        ...
        localTree.createHeaderList(mapItemToSupport);
        return localTree;
    }
    ...
    public void printStats() {
        ...
        System.out.println(" FUIs count : " + huiCount);
        System.out.println("===================================================");
    }
}
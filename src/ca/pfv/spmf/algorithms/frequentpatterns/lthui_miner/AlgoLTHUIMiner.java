...
public class AlgoLTHUIMiner {
     ...
     * @param lminutil               The local minimum utility threshold.
     * @param winLen                 The length of a sliding window.
     * @param binLen                 The length of a bin.
     * @param minSlope               The minimum slope threshold (increasing trend).
     * @param databaseStartTimestamp The start timestamp of the database.
     * @param outputIndex            If true, then output period with the index of bins,
     ...
     * @param pUL          This is the TU-list of the prefix. Initially, it is empty.
     * @param ULs          The TU-lists corresponding to each extension of the
     *                     prefix.
     * @param lminutil     The local minimum utility threshold.
     * @param winLen       The length of a sliding window.
     * @param binLen       The length of a bin.
     * @param minSlope     The minimum slope threshold.
     * @param outputIndex  If true, then output period with the index of bins,
     *                     otherwise, output period with timestamp
     * @throws IOException
     */
     ...
     *
     * @param P  : the TU-list of prefix P.
     * @param px : the TU-list of pX
     * @param py : the TU-list of pY
     ...
     *
     * @param p        prefix of pX
     * @param pX       the TU-list of target itemset
     * @param lminutil local minimum threshold of utility
     * @param winLen   the length of a sliding window
     * @param binLen   the length of a bin
     * @param minSlope the minimum slope of utility over time in a sliding window
     */
     ...
     *
     * @param tul      The TU-list of an itemset
     * @param winStart the index of start bin of the sliding window
     * @return slope of the itemset in the sliding window
     */
     ...
     *
     * @param tul a TU-list for a LTHUI
     */
     ...
     *
     * @param prefix       prefix to be wrote to the output file
     * @param prefixLength the prefix length
     * @param ult          the TU-list of the LTHUI
     * @param binLen       the length of bins
     * @param outputIndex  If true, then output period with the index of bins,
     *                     otherwise, output period with timestamp
     * @throws IOException
     */

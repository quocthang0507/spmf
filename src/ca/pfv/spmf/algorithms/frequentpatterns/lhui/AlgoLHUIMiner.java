...
public class AlgoLHUIMiner {
     ...
     *
     * @param ulp          LU-list of itemset p
     * @param winEnd       the ending index of first window, actually this is the
     ...
     * @param rutil        the sum of iutil+rutil in first window
     * @param utilPreflag  indicates if first window is a promising LHUI period

...
public class AlgoLevelWise {
    ...
    /*
     * The first time to deal the frequent closed itemsets. read the file of longest
     * combination of frequent closed itemsets and put them into a ArrayList. read
     * the file which combination is the longest combination minus 1 and put them
     * into a ArrayList.
     */
    ...
    /*
     * After the first time to deal the frequent closed itemsets. read the file
     * which combination is the recently longest combination minus 1 and put them
     * into a ArrayList.
     */
    ...
    /*
     * clear the hashtable of longest combination frequent closed itemsets fill it
     * with the other hashtable which was generated former clear the other hashtable
     * which was generated former clear the ArrayList which was used to store the
     * frequent closed itemsets former clear the ArrayList which was used to store
     * the other frequent closed itemsets former
     */

...
public class IHAUPM {
     ...
     *
     * @param quanAry , quanity array of node
     * @param result  , discovered itemsets
     * @param curNode , current processing node
     */
    private void getCombination(List<IAUNode.IAUPair> quanAry,
        ...
        while (stack.size() != 0) {
            ...
            Loop:
            for (int k = ele.location - 1; k >= 0; k--) {
     ...
     * itemsets
     *
     * @param name1 , one itemset
     * @param name2 , another itemset
     ...
     *
     * @param arys , quantity arrays in the current hlink
     */
     ...
     *
     * @param a , quantity array of node
     * @param b , quantity array of another node

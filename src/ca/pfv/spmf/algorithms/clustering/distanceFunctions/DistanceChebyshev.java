...
/**
 * This class implements the Chebyshev distance function. It is a subclass of the
 ...
 * two vectors of double and returns a value that is a positive number
 * A smaller value indicates that the two vectors are closer.
 * Note: this function does not work well with algorithms such as K-Means (the algorithm may not converge).
 * <br/><br/>
 *
...
public class DistanceChebyshev extends DistanceFunction {
    ...
    /**
     * Calculate the Chebyshev distance between two vectors of doubles.
     *

 ...
 */
public class MainTestHUCIMiner_closed_only {
    ...
    public static void main(String[] arg) throws IOException {
        ...
        algorithm.setDontOutputGeneratorItemsets(true);
        algorithm.runAlgorithmHUCIMiner(input, output, min_utility);
        algorithm.printStats();
    }

    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTestHUCIMiner_closed_only.class.getResource(filename);

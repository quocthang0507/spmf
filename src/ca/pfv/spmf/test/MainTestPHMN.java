...
public class MainTestPHMN {
    ...
    public static void main(String[] arg) throws IOException {
        ...
        // Run the algorithm
        // Note:  the parameter "false" is what tells to run PHMN instead of PHMN+
        algorithm.runAlgorithm(false, input, output, min_utility,
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTestPHMN.class.getResource(filename);

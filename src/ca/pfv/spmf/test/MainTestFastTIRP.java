...
/**
 * Example of how to use the FastTIRP algorithm from the source code.
 *
...
public class MainTestFastTIRP {
    ...
    public static void main(String[] arg) throws IOException {
        ...
        // This optimization must be set to true to run FastTIRP
        //  If it is set to true, then it becomes the VertTIRP algorithm
...
//		algo.removeRelation(Relation.E);
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTestFastTIRP.class.getResource(filename);
